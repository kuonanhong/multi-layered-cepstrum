...
from mlc import MLC_CFP

parser = argparse.ArgumentParser(description='Multi-layered Cepstrum on bach10 dataset.')
...
if __name__ == '__main__':
    ...
    a = time()
    result, t = MLC_CFP(y, args.g, sr, window_size=args.window_size, med_num=args.med_num,
